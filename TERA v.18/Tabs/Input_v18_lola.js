// INPUT TAB – T.E.R.A. v18 / v18-lola
// New v15 commands:
...
//           LocalizedLanguages("input") runs first so any language
//           selection commands are resolved before TERA's echo, resonance,
//           and /tera command parser see the input.
//           Set USE_LOLA = false if LoLa is not installed.

// ── LoLa toggle ───────────────────────────────────────────────────────
const USE_LOLA_INPUT = true;
...
const modifier = (text) => {
  ...
  // ── LoLa input processing ──────────────────────────────────────────
  // LoLa reads {Language: xxx} player commands and updates its state.
  // Runs last so it sees the fully processed input text after TERA is done.
  if (USE_LOLA_INPUT && typeof LocalizedLanguages === "function") {
